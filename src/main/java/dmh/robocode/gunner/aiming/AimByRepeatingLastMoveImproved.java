...
/*    */ 
/*    */ public class AimByRepeatingLastMoveImproved extends CalibratedAimingStrategyUsingEnemySimulator
/*    */ {
...
/*    */ 
/*    */   public AimByRepeatingLastMoveImproved(CommandBasedRobot myRobot, EnemyRobot enemy, boolean isLearningAllowed)
/*    */   {
...
/*    */ 
/* 65 */         EnemySimulator simulator = new SteadyChangeEnemySimulatorImproved(latestObservation.getLocation(), latestObservation.getVelocity(), latestObservation.getHeading(), acceleration, rateOfTurn);
/*    */ 
 ...
 * Qualified Name:     dmh.robocode.gunner.aiming.AimByRepeatingLastMoveImproved
